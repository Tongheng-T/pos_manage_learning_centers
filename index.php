...
<head>
    ...
    <title>POS SCHOOL | Log in | By:TH</title>
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="https://web.facebook.com/TonghengCoding" class="h1"><b>POS</b> SCHOOL</a>
            </div>

            <div class="card-body">
                <p class="login-box-msg">Sign in to start your session</p>
                <p class="center"><img src="resources/images/download (2).png" style="align-content: center" height="200px" alt=""></p>
                <?php login_user(); ?>
                <?php display_message(); ?>
