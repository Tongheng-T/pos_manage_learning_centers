        ...
        <form method="post" action="" name="">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body">
              ...
              $select = query("SELECT date , sum(sub_total) as grandtotal from invoices where date between '$date_1' AND '$date_2' group by date");
              confirm($select);
            ...
            $select = query("SELECT id_product ,date, sum(qty) as q from invoices where date between '$date_1' AND '$date_2' group by date");
            confirm($select);
            ...
            while ($row = $select->fetch_assoc()) {
              extract($row);
              $product_name=show_name_product_oder($id_product);
              $pname[] = $product_name;
              $qty[] = $q;
              $tdatee[] = $date;
            }
