...
<head>
    ...
    <title>របាយការណ៍ការបង់ប្រាក់ <?php echo show_categoryname($_SESSION['category_id']); ?> ប្រចាំខែ: <?php date_rank(); ?></title>
</head>
...
<body>
    <div class="my-5 page" size="A4" id="example-table">
        <div class="p-5">
            ...
            <div class="dddc">
                <h5>របាយការណ៍ការបង់ប្រាក់ <?php echo show_categoryname($tc_id); ?> ប្រចាំខែ <?php date_rank(); ?></h5>
            </div>
