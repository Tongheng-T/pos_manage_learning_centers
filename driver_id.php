...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="dist/css/driverr.css" media="all">
...
<body>
  ...
  <div id="wrapper">
    <div class="dowjpg">
      ...
      <div class="name">
        <h2 class="students">អ្នកបើកបរ</h2>
        <h2 class="Stud">ID HSD DV 00<?php echo $id ?></h2>
        <h2 class="st_name"><img src="productimages/driver/<?php echo $car_img?>" alt=""></h2>

        <h2 class="st_name">ឈ្មោះ <?php echo $car_namekh?></h2>
        <h2 class="st_name">ថ្ងៃកំណើត <?php echo date('d-m-Y', strtotime($dd)) ?></h2>
        <h2 class="st_name">ភេទ <?php echo $car_sex ?></h2>
        <h2 class="st_name">ទូរស័ព្ទ <?php echo $car_phone ?></h2>
